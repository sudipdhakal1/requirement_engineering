...
Add the following to your **existing Business Specification** document.
...
Add the following heading 2 sections:
...
Under **Acronyms and Abbreviations**, add a heading 2 for **Assumptions**.
